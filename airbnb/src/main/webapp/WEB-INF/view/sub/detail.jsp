...
<div class="container_1" id="summary">
	...
	<div>
		<a class="atag_1">${room.type}</a> <span aria-hidden="true"> ·
		</span> <a class="atag_1">${room.region}</a> <span aria-hidden="true">
			· </span> <a class="atag_1">후기 000개</a>
	</div>
	...
	<div class="container_3">
		...
		<table class="reviewTable">
			<tr>
				...
				<td class="content_3">엘리베이터<br> 반려동물 입실 가능<br> 가족/어린이
					숙박에 적합<br>
				</td>
			</tr>
			<tr>
