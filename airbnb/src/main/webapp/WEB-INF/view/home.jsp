...
<nav class="w3-display-right w3-sidebar w3-bar-block w3-card-2 w3-top w3-xlarge w3-animate-right" style="display:none;z-index:2;width:40%;min-width:300px" id="mySidebar">
    ...
    <form method="post" action="${pageContext.request.contextPath}/sub/sub_list">
        ...
        <div class="w3-row w3-border">
            <div class="w3-col s4 w3-left">
                <p>
                <label style="padding-left:8px;">위치</label>
                <input class="w3-input border_bottom0 area-80" type="text" placeholder="모든 위치" name="location" >
                </p>
            </div>
            ...
            <div class="w3-col s4 w3-left" id="changDate">
                <div class="w3-col s4 w3-left">
                    <p>
                        <label style="padding-left:8px;">날짜</label>
                        <input class="w3-input date-input1 border_bottom0 area-100"   type="text" id="startDate" name="startDate" placeholder="체크인" style="text-align:right">
                    </p>
                </div>
                ...
                <div class="w3-col s4 w3-left">
                    <p>
                        <label>&nbsp;</label>
                        <input class="w3-input date-input1 border_bottom0 area-100" type="text" id="endDate" name="endDate" placeholder="체크아웃">
                    </p>
                </div>
            </div>
            ...
            <div class="w3-col s4 w3-left">
                <div class="w3-col s9 w3-left">
                    ...
                    <div class="flex1">
			            ...
			            <input id="personInput" name="amount" type="number"  max="9999" maxlength="4" oninput="maxLengthCheck(this)" style="width:150px;">
		                <span class="currency1">명</span>
                    </div> 
                </div>
                <div class="w3-col s3 w3-right" style="padding-left:20px;padding-top:10px;">
                    <p><button class="w3-button w3-red w3-round-large">검색</button></p>
                </div>
            </div>
        </div>
    </form>    
