			...
			<div>
				<form action="${pageContext.request.contextPath}/mypage/wishlist"
					...
					<div class="w-add wfont_2">
						<div class="wlwl">
							<label class="w-lb" for="w-check"> 관심 위시리스트 제목 <input
								class="w-check" type="checkbox" id="w-check">
							</label>
						</div>
					</div>
					<div class="w-add wfont_2">관심 위시리스트 제목2</div>
					<div class="w-add wfont_2">관심 위시리스트 제목3</div>
				</form>
				<div>
					<div class="wl-box_3">
						<button class="wbtn2">
							...
							<div class="wl-box_1">
								<div class="wl-box_2 wfont_3">Romantic front lake Como
									attic</div>
